...
/* ============================================================
   ...
   - Full field validation on submit
   - Success animation
   ============================================================ */
function initRegistrationForm() {
  ...
  const fields = [
    {
      id: 'fname',
      errId: 'fnameErr',
      errMsg: 'Please enter your full name (min 2 characters)',
    ...
    },
    {
      id: 'phone',
      errId: 'phoneErr',
      errMsg: 'Enter a valid phone number (min 10 digits)',
      test: v => v.replace(/\D/g, '').length >= 10
    },
    {
      id: 'year',
      errId: 'yearErr',
      errMsg: 'Please select your year of study',
      test: v => v !== ''
    },
    {
      id: 'college',
      errId: 'collegeErr',
      errMsg: 'Please enter your college / department',
      test: v => v.trim().length >= 2
    },
    {
      id: 'evSelect',
      errId: 'evErr',
      errMsg: 'Please select an event to register for',
      test: v => v !== ''
    },
  ];
  ...
  form.addEventListener('submit', e => {
    ...
    if (allValid) showRegistrationSuccess();
  });
}
